...
const Login = ({ footerNavigator, onLoginSuccess }) => {
  ...
  return (
    <div className="p-2 rounded-3xl bg-gray-200">
      <div className="flex flex-col items-center justify-center w-[600px] bg-white rounded-2xl p-4">
        ...
        <h1 className="text-black font-bold text-2xl pt-4">Sign in to continue</h1>
        <h2 className="text-gray-400 font-thin text-md mt-2">Sign in to access all features on this app</h2>
      ...
      <p className="text-gray-600 font-bold text-sm mt-4 mb-2">Don't have an account? {footerNavigator}</p>
    </div>
  )
}
